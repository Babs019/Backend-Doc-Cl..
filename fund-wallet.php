        ...
        <div class="card card-style bg-theme pb-0">
            <div class="content" id="tab-group-1">
			  ...
			  ?>
			      <div class="">
            <div class="content" id="tab-group-1">
          <h2> Generate account Number</h2>
                <p class="mb-0 font-600 color-highlight">To fund your wallet automatically by Bank transfer,You need to generate an Dedicated account number using your BVN.Be advised that 
				we do not have access to your Bank accounts and your BVN information is not stored on our servers.Your BVN is soely for
				Verification</p>
              

        <a  href="update-bvn" style="width: 100%;" class="btn btn-full btn-l font-600 font-15 gradient-highlight mt-4 rounded-s">
                               <i class="fa fa-home mr-2"></i> Generate account Number
                            </a>
            </div>
            </div>
